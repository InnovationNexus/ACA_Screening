...
Public Class QDependency
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        lnkBack.NavigateUrl = "~/SurveyManagement/SurveyQuestions.aspx?SurveyTypeID=" + Request.QueryString("SurveyTypeID") + "&QuestionID=" + Request.QueryString("QuestionID")
    End Sub
    ...
    Private Sub rptExistingDependencies_ItemCommand(source As Object, e As System.Web.UI.WebControls.RepeaterCommandEventArgs) Handles rptExistingDependencies.ItemCommand
        If e.CommandName = "Delete" Then
            Dim cnn As New SqlConnection(ConfigurationManager.ConnectionStrings("ACA_ScreeningConnectionString").ToString())
            Dim cmd As New SqlCommand("prcScreening_DELETE_QuestionDependency", cnn)
            cmd.CommandType = CommandType.StoredProcedure
    ...
    Private Sub btnAddDependency_Click(sender As Object, e As System.EventArgs) Handles btnAddDependency.Click
        Dim cnn As New SqlConnection(ConfigurationManager.ConnectionStrings("ACA_ScreeningConnectionString").ToString())
        Dim cmd As New SqlCommand("prcScreening_ADD_QuestionDependency", cnn)
        cmd.CommandType = CommandType.StoredProcedure
        With cmd.Parameters
            .Add("QuestionID", SqlDbType.BigInt).Value = Request.QueryString("QuestionID")
