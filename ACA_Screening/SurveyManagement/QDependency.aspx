<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="QDependency.aspx.vb" Inherits="ACA_Screening.QDependency" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource runat="server" ID="srcInfo"
            ...
            SelectCommand="SELECT quest.ID, CASE WHEN ISNULL(DesignerNote, '') = '' THEN '' ELSE '[' + DesignerNote + '] ' END + QuestionText AS Question, quest.QuestionText, quest.QuestionSequence, surv.SurveyName FROM tblScreening_Questions quest INNER JOIN tblScreening_SurveyTypes surv ON (quest.SurveyTypeID = surv.ID) WHERE quest.ID = @QuestionID"
            SelectCommandType="Text"
            >
            <SelectParameters>
                <asp:QueryStringParameter Name="QuestionID" Type="Int32" QueryStringField="QuestionID" />
            </SelectParameters>
        </asp:SqlDataSource>
        ...
        <b>Select a combination of up to 5 answers for this question to be dependent upon (i.e. The specified answers must be selected in order for this question to be displayed.):</b><br />
        <br />
        ...
        <div>
            ...
            <asp:SqlDataSource ID="srcExistingDependencies" runat="server" ConnectionString="<%$ ConnectionStrings:ACA_ScreeningConnectionString %>"
                SelectCommand="prcScreening_List_DependenciesForQuestionID" SelectCommandType="StoredProcedure">
                <SelectParameters>
